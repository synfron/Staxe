...
{
	public readonly struct DefaultIntValue<G> : IValue<G, int> where G : IGroupState<G>, new()
	{
		public DefaultIntValue(int data)
		{
			Data = data;
		}
		...
		{
			return obj is IValue<G, int> other ? Data == other.Data : false;
		}
		...
		public void Deconstruct(out int data)
		{
			data = Data;
		}
	}
