...
{
	public readonly struct DefaultLongValue<G> : IValue<G, long> where G : IGroupState<G>, new()
	{
		public DefaultLongValue(long data)
		{
			Data = data;
		}
		...
		public ValueType ValueType => ValueType.Long;
		...
		private IValuable<G> Or(long value, IValueProvider<G> valueProvider)
		{
			return valueProvider.GetReducedValue(Data | value);
		}
		...
		{
			return obj is IValue<G, long> other ? Data == other.Data : false;
		}
		...
		public IValuable<G> And(IValuable<G> value, IValueProvider<G> valueProvider)
		{
			...
			{
				case IValue<G, int> intValue:
					return And(intValue.Data, valueProvider);
				case IValue<G, long> longValue:
					return And(longValue.Data, valueProvider);
				default:
		...
		public IValuable<G> Or(IValuable<G> value, IValueProvider<G> valueProvider)
		{
			...
			{
				case IValue<G, int> intValue:
					return Or(intValue.Data, valueProvider);
				case IValue<G, long> longValue:
					return Or(longValue.Data, valueProvider);
				default:
		...
		public IValuable<G> LeftShift(IValuable<G> value, IValueProvider<G> valueProvider)
		{
			...
			{
				case IValue<G, int> intValue:
					return LeftShift(intValue.Data, valueProvider);
				default:
		...
		public void Deconstruct(out long data)
		{
			data = Data;
		}
	}
